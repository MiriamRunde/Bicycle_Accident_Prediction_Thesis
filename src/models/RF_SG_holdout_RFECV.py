...
print(f"Filtered to {len(df)} rows for group type SG")
...
# ---------------------------------
# 3. Feature Selection: RFECV + LOGO
# ---------------------------------
print("🔍 Running RFECV with LOGO...")
...
print(f"✅ RFECV selected {len(selected_rfecv)} features")
print(f"✅ RFECV selected {selected_rfecv} features")
X_sel = X[selected_rfecv]
